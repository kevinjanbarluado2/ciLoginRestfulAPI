        ...
        <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main" data-color="info">
            <div class="sidenav-header">
                ...
                <a class="navbar-brand m-0" href="#">
                    ...
                    <span class="ms-1 font-weight-bold">EliteInsure Investments</span>
            ...
            <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link <?= ($link == "dashboard") ? 'active' : ''; ?>" href="<?= base_url() ?>dashboard">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= ($link == "planner") ? 'active' : ''; ?>" href="<?= base_url() ?>planner">
                            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            ...
                            <span class="nav-link-text ms-1">Fact Find</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= ($link == "plan") ? 'active' : ''; ?>" href="<?= base_url() ?>plan">
                            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            ...
                            <span class="nav-link-text ms-1">Analysis and Recommendation</span>
                        </a>
                    </li>
                ...
                <div class="container-fluid py-1 px-3">
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        ...
                        <li class="nav-item dropdown px-3 d-flex align-items-center">
                            <a href="<?= base_url('logout') ?>" class="nav-link text-body p-0" aria-expanded="false">
